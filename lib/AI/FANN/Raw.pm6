...
enum fann_nettype is export « :FANN_NETTYPE_LAYER(0) FANN_NETTYPE_SHORTCUT »;
...
#sub fann_create_standard_array(uint8 $num_layers) returns fann is export is native(&fannlib) {*}
